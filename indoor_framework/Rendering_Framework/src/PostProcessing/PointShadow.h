...
namespace INANOA {
	namespace POST_PROCESSING {
		...
		{
		public:
			enum class PointShadowSubProcess : int {
		...
		private:
			...
			inline void setPointShadowSubProcess(const PointShadowSubProcess type) {
			...
			// since each cube face has different view matrix 
			std::vector<glm::mat4> _light_view_mat;
